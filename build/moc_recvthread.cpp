...
void RecvThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (RecvThread::*_t)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&RecvThread::NewMessage)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void RecvThread::NewMessage(QString _t1)
{
